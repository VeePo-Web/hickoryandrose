            ...
            >
              ...
              <div className="flex items-center justify-between py-7 md:py-10 cursor-default relative">
                ...
                <div className="flex items-baseline gap-4 md:gap-6 relative">
                  ...
                  {/* Publication name */}
                  <span className="font-serif-wedding text-2xl md:text-3xl lg:text-4xl font-light text-foreground/70 group-hover:text-foreground/70 transition-colors duration-500 tracking-tight italic">
                    {pub.name}
                  </span>
